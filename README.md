...
It also publishes SARIF results (Gitleaks, Bandit, Trivy) to GitHub code scanning on trusted events, so findings are visible in the repository Security views (not just raw CI logs).
